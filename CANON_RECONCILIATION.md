...
| Provider-neutral prototype | Direct human authority | `CANONICAL` | Cal.com is an example only. Support Google Calendar appointment pages, Calendly, Cal.com, another safe link/embed, callback-only, and unavailable states through one prototype contract. |

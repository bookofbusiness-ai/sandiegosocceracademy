...
- **Missing:** Approved claims, direct class URLs or catalog fallback, and tracking consent.
...
- **Human decision:** Test structure, 30-mile radius, $200 total cap, 10-day equal allocation, and adults 25-65+ audience approved on 2026-09-17. The fixed enrollment threshold was rejected; registrations and cost per registration are the outcome measures. Tracking, destination URLs, and approved claims remain unresolved.

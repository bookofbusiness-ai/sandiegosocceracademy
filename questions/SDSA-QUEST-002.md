...
- **Missing:** Audience definition within the approved radius; approved claims; direct class URLs or catalog fallback; and tracking consent.
...
- **Human decision:** Test structure, 30-mile radius, $200 total cap, and 10-day equal allocation approved on 2026-09-17. The fixed enrollment threshold was rejected; registrations and cost per registration are the outcome measures. Detailed audience, tracking, destination URLs, and approved claims remain unresolved.
